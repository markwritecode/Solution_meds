...
if ($_POST['mode'] == 'StripePayStack') {
    $form_pid = $_POST['form_pid'];
    $invoice = isset($_POST['invValues']) ? $_POST['invValues'] : '';
    $cc = array();
    $cc["cardHolderName"] = $_POST["cardHolderName"];
    $cc['status'] = $_POST['transaction_status'];
    $cc['authCode'] = "OTP";
    $cc['transId'] = $_POST['transaction_ref'];
    $cc['cardNumber'] = $_POST['transaction_ref'];
    $cc['cc_type'] = "Debit";
    $cc['zip'] = "910091";
    $ccaudit = json_encode($cc);
    $_SESSION['whereto'] = 'paymentcard';
