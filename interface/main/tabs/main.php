...
<head>
    ...
    <title><?php echo "SolutionMed" ?></title>
...
<body class="min-vw-100">
    ...
    <div id="mainBox" <?php echo $disp_mainBox ?> >
        <nav class="navbar navbar-expand-xl navbar-light bg-light py-0">
            ...
            <a class="navbar-brand mt-2 mt-xl-0 mr-3 mr-xl-2" href="https://www.solutionmed.net" title="<?php echo "SolutionMed" ?>" rel="noopener" target="_blank">
                <img src="/public/images/menu-logo.png"); " alt="" width="50"> 
            </a>
